# Torches in Water ![Icon](./src/main/resources/assets/torches_in_water/icon.png)
[中文](./README.md)
...
[![Curseforge](https://cf.way2muchnoise.eu/975372.svg)](https://www.curseforge.com/minecraft/mc-mods/torches-in-water)
## Synopsis
- Glow ink torch, which can be placed in water.
## Profile
Added torches which can be placed in water.
### Glow Ink Torch.
...
## Gallery
![Glow ink torches in frozen ocean](./gallery/glow_ink_torches_in_frozen_ocean.png)
![Glow ink torches in water flow](./gallery/glow_ink_torches_in_water_flow.png)
## Trivia
This mod is inspired by Aquatic Torch of [《Aquatic Torches》](https://modrinth.com/mod/aquatic-torches).