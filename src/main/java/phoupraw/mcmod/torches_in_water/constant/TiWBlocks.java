...
public sealed interface TiWBlocks permits InterfaceFinaler {
    Block GLOW_INK_TORCH = r(TiWIDs.GLOW_INK_TORCH, new GlowInkTorchBlock(FabricBlockSettings.copyOf(Blocks.TORCH).luminance(TiW.CONFIG().instance().glowInkTorch_luminance)));
